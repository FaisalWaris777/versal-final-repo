...
export default function COMPANY_COMPONENT_3(props) {
    ...
    useEffect(()=>{
     ...
     const fuel_options= {
      ...
      <Chart options={options} series={body_series} type="bar" height={'100%'} width={'100%'}/>
      </div><div className='finding'>
      <h3>Inference</h3>
      ...
      <div className='comp-chart'>
      <Chart options={fuel_options} series={fuel_series} type="donut" height={'100%'} width={'100%'}/>
      </div><div className='finding'>
      <h3>Inference</h3>
